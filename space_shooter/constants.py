...
ACCELERATION = 20  # Ship acceleration in units/sec/sec
...
AST_SIZE_SCALE = .2  # How much asteroid scale changes when broken up
AST_MIN_SCALE = 0.3  # If and asteroid is smaller than this and is hit, it disapears instead of splitting up
